...
function drawJoysticks(ctx, joystick) {
	if(joystick.left.dx > 0 || joystick.left.dy > 0) {
		...
		drawCircle(ctx, joystick.left.x + joystick.radius * joystick.left.dx, joystick.left.y + joystick.radius * joystick.left.dy, joystick.radius / 4, 'gray', 'white');
	}
	if(joystick.right.dx > 0 || joystick.right.dy > 0) {
		drawCircle(ctx, joystick.right.x, joystick.right.y, joystick.radius, 'gray', 'black');
		drawCircle(ctx, joystick.right.x + joystick.radius * joystick.right.dx, joystick.right.y + joystick.radius * joystick.right.dy, joystick.radius / 4, 'gray', 'white');
	}
}
